...
object BobbyVersionRange:
  ...
  given bobbyVersionRangeStringBindable(using stringBinder: QueryStringBindable[String]): QueryStringBindable[BobbyVersionRange] with
