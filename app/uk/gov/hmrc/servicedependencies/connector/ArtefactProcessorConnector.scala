...
class ArtefactProcessorConnector @Inject()(
  ...
  def getMetaArtefact(repositoryName: String, version: Version)(using hc: HeaderCarrier): Future[Option[MetaArtefact]] =
    given Reads[MetaArtefact] = MetaArtefact.apiFormat
    httpClientV2
